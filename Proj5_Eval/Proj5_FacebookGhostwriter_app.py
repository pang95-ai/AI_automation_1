"""Facebook post ghostwriter using OpenAI API.

Generates an inspiring post about MacKenzie Scott's philanthropy
in a 3-part format: Hook, Body, and Call to Action.
"""
...
SYSTEM_PROMPT = (
    ...
    "2. BODY (up to 250 words): Deliver the story with concrete details, "
    "names, and numbers. Build from personal to universal. "
    "Keep paragraphs short for mobile readability.\n"
    "3. CTA (1-2 lines): A short, focused call to action that inspires "
    "the reader to reflect or act.\n\n"
